...
"}"));
        ...
        pushButton_4->setStyleSheet(QString::fromUtf8("background-image: url(:/image/background.png);\n"
"border-image: url(:/image/\351\237\263\345\223\215 (2).png);"));
        ...
        pushButton_3->setStyleSheet(QString::fromUtf8("background-image: url(:/image/background.png);\n"
"border-image: url(:/image/\347\251\272\350\260\2033.png);"));
        ...
        pushButton_5->setMinimumSize(QSize(75, 66));
        pushButton_5->setMaximumSize(QSize(75, 66));
        pushButton_5->setStyleSheet(QString::fromUtf8("border-image: url(:/image/\345\244\251\346\260\224.png);\n"
"background-image: url(:/image/background.png);"));
        ...
        pushButton_7->setStyleSheet(QString::fromUtf8("background-image: url(:/image/background.png);\n"
"border-image: url(:/image/\346\270\251\345\272\246.png);"));
        ...
        pushButton_6->setMinimumSize(QSize(75, 66));
        pushButton_6->setMaximumSize(QSize(75, 66));
        pushButton_6->setStyleSheet(QString::fromUtf8("background-image: url(:/image/background.png);\n"
"border-image: url(:/image/\347\252\227\345\270\230 (1).png);"));
        ...
        pushButton_2->setStyleSheet(QString::fromUtf8("border-image: url(:/image/\347\201\257.png);\n"
"background-image: url(:/image/background.png);"));
    ...
    void retranslateUi(QMainWindow *Home)
    {
        ...
        lineEdit->setText(QApplication::translate("Home", "COM3", Q_NULLPTR));
